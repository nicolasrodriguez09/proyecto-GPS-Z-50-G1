...
Route::get('/identity-evidence/create', [IdentityEvidenceController::class, 'create'])
    ->name('identity-evidence.create');

Route::post('/identity-evidence', [IdentityEvidenceController::class, 'store'])
    ->name('identity-evidence.store');
...
Route::middleware(['auth', 'role:arrendador'])->group(function () {
    ...
    // Panel principal
    Route::get('/arrendador', [ArrendadorController::class, 'index'])
        ->name('arrendador');
...
Route::middleware(['auth', 'role:arrendatario'])->group(function () {
    ...
    // Marketplace
    Route::get('/arrendatario', [ArrendatarioController::class, 'index'])
        ->name('arrendatario');

    // Ver producto
    Route::get('/products/{product}', [ArrendatarioController::class, 'show'])
        ->name('products.show');
